...
// To implement an interface, we just need to implement all the methods
//    in the interface on each struct that we want to satisfy the interface
//    (also known as "fulfill the contract" of the interface)
